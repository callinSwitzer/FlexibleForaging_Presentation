...
ggsave(file.path(figDir, "beeSonicationPercentage_StartStop.png"), units = "in", dpi = 500, 
       width = 7, height = 4)
...
# save as png
save_plot(file.path(figDir, "002_CombinedFreqAmp_rewNoRew_IT_Order.png"), plot = aa, dpi = 500,  base_width = 8, base_height = 5)
